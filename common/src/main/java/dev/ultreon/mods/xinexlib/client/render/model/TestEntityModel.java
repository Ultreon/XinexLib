...
import dev.ultreon.mods.xinexlib.client.render.TestEntityRenderState;
...
public class TestEntityModel<T extends TestEntityRenderState> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "test_entity"), "main");
